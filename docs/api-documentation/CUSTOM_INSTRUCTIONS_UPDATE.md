...
**Notebook Mapping:**
- Tier 1: `Tier1_Inequality_Analysis_ACS.ipynb`  **SKELETON** - Inequality metrics calculation
...
**Notebook Mapping:**
- Tier 2: `Tier2_Education_Performance_NCES.ipynb`  **SKELETON** - Education outcome modeling
...
**Notebook Mapping:**
- Tier 1: `Tier1_Housing_Markets_HUD.ipynb`  **SKELETON** - Housing market descriptives
- Tier 2: `Tier2_Housing_Hedonic_Zillow.ipynb`  **SKELETON** - Hedonic pricing models
...
**Notebook Mapping:**
- Tier 3: `Tier3_Economic_Forecasting_FRED.ipynb`  **SKELETON** - Macro forecasting
...
| 2. Inequality | Analysis  | Determinants | - | - | - | Decomposition |
| 3. Employment | - | Forecasting  | Dynamics | Clusters | - | - |
| 4. Education | - | Performance  | - | Clusters | - | - |
| 5. Health | - | Outcomes | - | - | - | Mortality |
| 6. Housing | Markets  | Hedonic  | - | - | - | Eviction Risk |
...
| 18. Futures | - | - | Forecasting  | - | Scenarios | - |
...
def load_{dataset}_data(
    ...
    try:
        ...
        print(f"  Geographic level: {geography}")

        return df

    except requests.exceptions.RequestException as e:
        print(f" API request failed: {e}")
        print(f"ℹ  Falling back to cached data if available...")
...
if registry_path.exists():
    ...
    if notebook_name in [nb['notebook_name'] for nb in registry['notebooks']]:
        ...
        print(f"  WARNING: Notebook not found in registry - add entry to config/notebook_registry.json")
else:
...
if khipu_executor_path.exists():
    ...
    print("ℹ  Khipu executor not found - notebook available for educational use only")
```
...
print(f"⏱  Duration: {execution_summary['duration_seconds']:.2f} seconds")
